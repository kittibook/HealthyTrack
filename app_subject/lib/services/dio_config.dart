import 'package:app_subject/utils/constants.dart';
...
class DioConfig {
  ...
  static _getToken() async {
    // _token = await Utility.getSharedPreference('token');
  }
  ...
  // ฟังก์ชันในการดึง token จาก shared preference โดยรับ BuildContext
  // static Future<void> _getToken(BuildContext context) async {
  //   _token = await Utility.getSharedPreference('token');
